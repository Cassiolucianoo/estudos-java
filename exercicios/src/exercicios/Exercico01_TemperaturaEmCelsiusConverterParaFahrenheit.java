...
public class Exercico01_TemperaturaEmCelsiusConverterParaFahrenheit {

	public static void main(String[] args) {
	/*  1- Criar um programa que leia a temperatura em Celsius 
		...
		4 -Criar um programa que leia um valor e apresente 
